...
const columns = [
  ...
  },
  {
    ...
    render: (text, record) => {
      return (
        <div>
          <div className="flex items-center"><FaUserCircle className="mr-1"/> Nguyễn Văn A</div>
    ...
    <div className="lichsucuocgoi pb-3">
      <div className="lichsucuocgoi__header px-3 py-2 flex justify-between">
        <div className="lichsucuocgoi__header__left flex gap-3">
          ...
          <div className="cursor-pointer text-base">Lịch sử chung</div>
          <div className="cursor-pointer text-base">Lịch sử cá nhân</div>
        </div>
